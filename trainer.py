...
def main():
    ...
    parser.add_argument('-r', '--regularizer', action=argparse.BooleanOptionalAction, default=False, type=bool)
    parser.add_argument('-s', '--spectral-norm', action=argparse.BooleanOptionalAction, default=False, type=bool)
    parser.add_argument('-w', '--weight-decay', default=5.e-4, type=float, help='weight decay (default: 1.e-4)')
    ...
    regularizer = TotalNeuralStiffness(lagrange=arguments.lagrange) if arguments.regularizer else None
